...
class V1APICredentialsCreateAPICredentialRequestTypedDict(TypedDict):
    organization_id: str
    r"""The <code>id</code> of the Organization where you want to create the API Credential."""
    api_credential_create_request_dto: APICredentialCreateRequestDTOTypedDict


class V1APICredentialsCreateAPICredentialRequest(BaseModel):
    ...
    api_credential_create_request_dto: Annotated[
        APICredentialCreateRequestDTO,
