# Billing.Credits.ContractsUtilization

## Overview

### Available Operations

* [list](#list) - Get contract credit utilization
...
with CriblMgmtPlane(
    ...
    res = cmp_client.billing.credits.contracts_utilization.list(organization_id="<id>", starting_on=parse_datetime("2025-05-01T00:00:00Z"), ending_before=parse_datetime("2025-06-01T00:00:00Z"), window=models.BillingWindow.MONTHLY)
